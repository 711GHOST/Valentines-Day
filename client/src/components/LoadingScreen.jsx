...
export default function LoadingScreen(){
  return (
    <div className="flex items-center justify-center min-h-screen px-4" style={{background:'linear-gradient(160deg,#efe8f6, #f6efe6)'}}>
      <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1}} className="text-center">
        <motion.h1 className="text-2xl md:text-3xl font-serif text-plum text-plum-600 text-plum-700" style={{color:'#6B3E6B'}} initial={{y:10}} animate={{y:0}} transition={{delay:0.2}}>

  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50" onClick={onClose}>
      <motion.div initial={{opacity:0, scale:0.8}} animate={{opacity:1, scale:1}} exit={{opacity:0, scale:0.8}} transition={{duration:0.3}} className="bg-white rounded-lg p-6 max-w-lg w-full relative" onClick={(e)=>e.stopPropagation()}>
        ...
        <div className="w-full bg-cover bg-center rounded-md" style={{ height: '75%', backgroundImage: `url(https://valentines-day-yufb.onrender.com${photo.imageURL})`, backgroundSize: 'cover', backgroundPosition: 'center', aspectRatio: '4 / 3', }}></div>
        <div className="mt-4">

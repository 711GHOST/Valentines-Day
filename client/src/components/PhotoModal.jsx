...
export default function PhotoModal({photo, onClose}){
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4">
      <motion.div initial={{opacity:0, scale:0.8}} animate={{opacity:1, scale:1}} exit={{opacity:0, scale:0.8}} transition={{duration:0.3}} className="bg-white rounded-lg p-4 md:p-6 max-w-sm md:max-w-lg w-full relative" onClick={(e)=>e.stopPropagation()}>
